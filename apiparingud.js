...
async function listiraamatud() {
    ...
    const responseData = await getDataAsJson("https://raamatudapp-hfhhdqhbgefph7hv.northeurope-01.azurewebsites.net/raamatud/");
	...
	for (var raamat of responseData.raamatud){
        ...
        resultElement.innerHTML += '<a href="https://raamatudapp-hfhhdqhbgefph7hv.northeurope-01.azurewebsites.net/raamatud/' + raamat + '"  download="' + raamat + '.txt" >' + raamat + ".txt</a> " +
         '<a href="#" onclick="deleteObject(\'https://raamatudapp-hfhhdqhbgefph7hv.northeurope-01.azurewebsites.net/raamatud/' + raamat + '/\')" > [kustuta]</a>' +
         "<br />";
